...
1.  **Punggol_St**: consists of line features representing the road network within the Punggol planning area.

2.  **Punggol_CC**: comprises point features indicating the locations of childcare centers within the same area.
